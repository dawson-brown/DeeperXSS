...
To take for example \urlline{http://website/search.php?uid=ws848d8024088c327.36898031\&src=\&term=<script>alert(123)</script>\&args=qs=06o} the following sequence of (token type, token value) pairs would be extracted going left to right:
...
\begin{figure}[H]
	\includegraphics[width=0.7\textwidth, angle=0]{cbow_model}
\end{figure}
